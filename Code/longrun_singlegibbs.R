...
matplot(beta0_history, type = 'l')

## traceplot for ksize
matplot(ksize_history, type = 'l')

save(N_accept, theta_accept, N_history, theta1_history, beta0_history, ksize_history,
     file = paste0("~/singlegibbs_fulldata_nmcmc", nmcmc, ".RData"))
